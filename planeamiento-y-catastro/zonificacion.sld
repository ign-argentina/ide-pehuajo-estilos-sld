...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>zonificación</se:Name>
    <UserStyle>
      <se:Name>zonificación</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>null</se:Name>
          <se:Description>
        ...
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>zonas</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>comercial</se:Name>
          <se:Description>
            <se:Title>comercial</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>zonas</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>esparcimiento</se:Name>
          <se:Description>
            <se:Title>esparcimiento</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>zonas</ogc:PropertyName>
              <ogc:Literal>ESPARCIMIENTO</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>recuperacion</se:Name>
          <se:Description>
            <se:Title>recuperacion</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>zonas</ogc:PropertyName>
              <ogc:Literal>RECUPERACION</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>reserva</se:Name>
          <se:Description>
            <se:Title>reserva</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>zonas</ogc:PropertyName>
              <ogc:Literal>RESERVA</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>reserva ensanche urbano</se:Name>
          <se:Description>
            <se:Title>reserva ensanche urbano</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>zonas</ogc:PropertyName>
              <ogc:Literal>RESERVA ENSANCHE URBANO</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>residencial</se:Name>
          <se:Description>
            <se:Title>residencial</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>zonas</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>uso especifico</se:Name>
          <se:Description>
            <se:Title>uso especifico</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>zonas</ogc:PropertyName>
              <ogc:Literal>USO ESPECIFICO</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
